...
if(SB_CONFIG_NETCORE_EMPTY)
  ...
  list(APPEND IMAGES "${SB_CONFIG_NETCORE_EMPTY_NAME}")

  if(NOT "${SB_CONFIG_NETCORE_EMPTY_DOMAIN}" IN_LIST PM_DOMAINS)
    list(APPEND PM_DOMAINS ${SB_CONFIG_NETCORE_EMPTY_DOMAIN})
  endif()
  list(APPEND PM_${SB_CONFIG_NETCORE_EMPTY_DOMAIN}_IMAGES
      "${SB_CONFIG_NETCORE_EMPTY_NAME}"
  )
  set(PM_${SB_CONFIG_NETCORE_EMPTY_DOMAIN}_IMAGES
      ${PM_${SB_CONFIG_NETCORE_EMPTY_DOMAIN}_IMAGES}
      PARENT_SCOPE
  )

  if(SB_CONFIG_NETCORE_EMPTY_DOMAIN_APP)
    set(DOMAIN_APP_${SB_CONFIG_NETCORE_EMPTY_DOMAIN}
        "${SB_CONFIG_NETCORE_EMPTY_NAME}" PARENT_SCOPE
    )
  endif()
