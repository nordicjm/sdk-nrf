...
/usr/bin/python3.11 /tmp/bb/bootloader/mcuboot/scripts/imgtool.py sign --key /tmp/bb/bootloader/mcuboot/root-rsa-2048.pem --header-size 0x200 --align 4 --version 0.0.0+0 --pad-header --slot-size 0xe0000 /tmp/bb/nrf/applications/zigbee_weather_station/_AA/intflash.hex /tmp/bb/nrf/applications/zigbee_weather_station/_AA/intflash_signed.hex
