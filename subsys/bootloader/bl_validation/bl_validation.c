...
#define MAGIC_COMPATIBILITY_VALIDATION_INFO ( \
...
#define VALIDATION_INFO_MAGIC CONFIG_FW_INFO_MAGIC_COMMON,CONFIG_SB_VALIDATION_INFO_MAGIC,MAGIC_COMPATIBILITY_VALIDATION_INFO
//#define VALIDATION_POINTER_MAGIC CONFIG_FW_INFO_MAGIC_COMMON,CONFIG_SB_VALIDATION_POINTER_MAGIC,MAGIC_COMPATIBILITY_VALIDATION_INFO
